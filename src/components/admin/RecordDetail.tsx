                ...
                {isEditing && key !== "id" && key !== "createdAt" && key !== "updatedAt" ? (
                  metadata.jsonFields.includes(key) ? (
                    <textarea
                      ...
                      rows={6}
                      className="w-full px-3 py-2 border border-border-strong rounded-lg focus:ring-2 focus:ring-brand-primary font-mono text-sm"
                    />
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2 border border-border-strong rounded-lg focus:ring-2 focus:ring-brand-primary"
                    >
                  ...
                  <div className={`text-sm ${metadata.jsonFields.includes(key) ? "font-mono bg-surface-muted p-3 rounded" : "text-text-primary"}`}>
