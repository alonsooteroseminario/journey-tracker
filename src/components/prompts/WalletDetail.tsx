        ...
        {isAddingGroup ? (
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 px-3 py-2 text-sm border border-border-strong rounded-lg focus:ring-2 focus:ring-brand-primary focus:border-transparent"
              autoFocus
            ...
            <button
              ...
              className="px-3 py-2 text-sm text-text-secondary hover:bg-surface-hover rounded-lg"
            >
              Cancel
            </button>
          </div>
