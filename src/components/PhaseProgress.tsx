...
export function PhaseProgress({ phases, tasks, onPhaseClick, onAddPhase }: PhaseProgressProps) {
  ...
  return (
    <div className="bg-surface rounded-lg shadow-sm border border-border p-2 sm:p-4">
      <h3 className="text-sm sm:text-lg font-bold text-text-primary mb-2 flex items-center gap-1">
            ...
            >
              ...
              <div className="flex items-center gap-1.5 sm:gap-3">
                ...
                <div className="flex-1 min-w-0 overflow-hidden">
                  ...
                  <p className="hidden sm:block text-xs text-text-muted truncate">{phase.description}</p>
                </div>
              ...
              {/* Progress Bar */}
              <div className="mt-1.5 sm:mt-3 h-1.5 sm:h-2 bg-surface-hover rounded-full overflow-hidden">
                <div
              ...
              {index < phases.length - 1 && (
                <div
                  className={`absolute left-3.5 sm:left-5 top-full w-0.5 h-2 ${
                    isComplete ? "bg-green-300" : "bg-surface-hover"
                  }`}
      ...
      {onAddPhase && (
        <button
          onClick={onAddPhase}
          className="w-full py-2 sm:py-3 border-2 border-dashed border-border-strong rounded-xl text-text-muted hover:border-brand-primary hover:text-brand-primary transition-colors flex items-center justify-center gap-1 sm:gap-2 text-xs sm:text-base mt-4"
        >
          <svg
