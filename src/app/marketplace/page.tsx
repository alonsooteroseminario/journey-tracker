        ...
        {pagination && pagination.pages > 1 && (
          <div className="mt-6 sm:mt-8 flex justify-center gap-2">
            <button
              ...
              disabled={page === 1}
              className="px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm bg-white border border-gray-200 rounded-lg disabled:opacity-50 disabled:cursor-not-allowed hover:bg-gray-50 text-gray-700"
            >
              Previous
            </button>
