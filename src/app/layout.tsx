  ...
  return (
    <ClerkProvider>
      <html lang="en" suppressHydrationWarning>
        ...
        <body
          className="antialiased min-h-screen bg-gradient-to-br from-white via-brand-light/30 to-indigo-50/60 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950"
